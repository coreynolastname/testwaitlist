...
export default function Waitlistcontainer() {
  return (
    <div className="relative z-10 bottom-1/4 left-1/2 transform -translate-x-1/2 translate-y-44 w-96 h-72 bg-waitlistcon rounded-3xl shadow backdrop-blur-3xl shadow-xl shadow-violet-500/30">
      <div className="absolute top-2 left-2 right-2 bottom-2 bg-indigospecial rounded-2xl">
        ...
        <div className=" absolute top-32 translate-y-1.5 left-12 translate-x-10 text-center leading-3 text-sm tracking-tighter opacity-90">Buy & Sell thrifted outfits in bundles</div>
        <Waitlistform/>
